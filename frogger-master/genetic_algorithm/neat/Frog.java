	...
	public void keyPressed(KeyEvent e) {
		if(state()){
			...
			if (key==KeyEvent.VK_RIGHT) {
				if(frog.getMaxX()+1*Display.GRID<Display.WIDTH&&sprite=="img/frog_right.png"){
					frog.x=frog.x+1*Display.GRID;
					frog.setLocation(frog.x, frog.y);			
				}
				else{
					changeSprite("img/frog_right.png");
				}
			}
			else if(key==KeyEvent.VK_LEFT) {
				if(frog.getMaxX()-1*Display.GRID>0&&sprite=="img/frog_left.png"){
					frog.x=frog.x-1*Display.GRID;
					frog.setLocation(frog.x, frog.y);
				}
				else{
					changeSprite("img/frog_left.png");
				}
			}
				...
				changeSprite("img/frog_front.png");
